...
4. Apply it with a `rules` subcommand from `frontend/` (edits `frontend/doctor.config.*` or `frontend/package.json#reactDoctor` in place, preserving other fields and formatting).
